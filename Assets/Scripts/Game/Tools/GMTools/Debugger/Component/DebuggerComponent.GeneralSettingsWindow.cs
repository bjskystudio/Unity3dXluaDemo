    ...
    public partial class DebuggerComponent
    {
        private sealed class GeneralSettingsWindow : ScrollableDebuggerWindowBase
        {
            ...
            public override void Initialize(params object[] args)
            {
                ...
                m_LastWindowWidth = DefaultWindowRect.width;//PlayerPrefs.GetFloat("Debugger.Window.Width", DefaultWindowRect.width);
                m_LastWindowHeight = DefaultWindowRect.height;//PlayerPrefs.GetFloat("Debugger.Window.Height", DefaultWindowRect.height);
                m_DebuggerComponent.WindowScale = m_LastWindowScale = DefaultWindowScale;//PlayerPrefs.GetFloat("Debugger.Window.Scale", DefaultWindowScale);
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        if (GUILayout.RepeatButton("-", GUILayout.Width(60f), GUILayout.Height(40f)))
                        {
                            width--;
                        }
                    ...
                    GUILayout.EndHorizontal();
                    GUILayout.Space(60f);
                    if (GUILayout.Button("Reset Window Settings", GUILayout.Height(60f)))
                    {
