namespace LuaBehaviourTree
{
    ...
    /// 设置自定义变量Bool行为节点
    /// </summary>
    public class SetShareBool : BaseAction
    {
        /// <summary>
        /// 需要改变的自定义变量名
        /// </summary>
        ...
        public SetShareBool(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
        ...
        {
            var result = OwnerBTGraph.UpdateData<bool>(mVariableName, mTargetVariableValue);
