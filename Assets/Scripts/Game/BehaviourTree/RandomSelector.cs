...
namespace LuaBehaviourTree
{
    ...
    public class RandomSelector : Composition
    {
        ...
        /// 子节点索引列表
        /// </summary>
        protected List<int> mChildIndexList;

        /// <summary>
        /// 子节点执行顺序栈
        /// </summary>
        protected Stack<int> mChildrenExecutionOrder;
        ...
        public RandomSelector(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
            OnCreate();
        }
