namespace LuaBehaviourTree
{
    ...
    /// 设置自定义变量Float行为节点
    /// </summary>
    public class SetShareFloat : BaseAction
    {
        /// <summary>
        /// 需要改变的自定义变量名
        /// </summary>
        ...
        #region 运行时部分
        public SetShareFloat()
        {

        }

        public SetShareFloat(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
