namespace LuaBehaviourTree
{
    ...
    /// 设置自定义变量String行为节点
    /// </summary>
    public class SetShareString : BaseAction
    {
        /// <summary>
        /// 需要改变的自定义变量名
        /// </summary>
        ...
        #region 运行时部分
        public SetShareString()
        {

        }

        public SetShareString(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
