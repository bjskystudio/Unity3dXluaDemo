...
namespace LuaBehaviourTree
{
    ...
    public class Composition : BTNode
    {
        ...
        public Composition(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
            ...
            for (int i = 0, length = node.ChildNodesUIDList.Count; i < length; i++)
            {
                ...
                var runningchildnode = BTUtilities.CreateRunningNodeByNode(originalchildnode, OwnerBT, this, worlditemuid, instanceid);
