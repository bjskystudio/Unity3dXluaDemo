namespace LuaBehaviourTree
{
    ...
    /// 比较自定义Int变量条件节点
    /// </summary>
    public class CompareShareInt : BaseCondition
    {
        /// <summary>
        /// 需要改变的自定义变量名
        /// </summary>
        ...
        #region 运行时部分
        public CompareShareInt()
        {

        }

        public CompareShareInt(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
        ...
        {
            var currentvariablevalue = OwnerBTGraph.GetData<int>(mVariableName);
