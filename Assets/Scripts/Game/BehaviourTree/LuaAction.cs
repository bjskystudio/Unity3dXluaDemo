namespace LuaBehaviourTree
{
    ...
    public class LuaAction : BaseAction
    {
        ...
        public LuaAction(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
