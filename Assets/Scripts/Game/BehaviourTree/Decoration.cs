namespace LuaBehaviourTree
{
    ...
    public class Decoration : BTNode
    {
        ...
        public Decoration(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
