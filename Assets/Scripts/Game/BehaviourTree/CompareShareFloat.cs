namespace LuaBehaviourTree
{
    ...
    /// 比较自定义Float变量行为节点
    /// </summary>
    public class CompareShareFloat : BaseCondition
    {
        /// <summary>
        /// 需要改变的自定义变量名
        /// </summary>
        ...
        #region 运行时部分
        public CompareShareFloat()
        {

        }

        public CompareShareFloat(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
