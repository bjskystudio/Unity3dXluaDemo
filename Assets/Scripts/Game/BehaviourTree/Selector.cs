namespace LuaBehaviourTree
{
    ...
    /// 选择节点
    /// </summary>
    public class Selector : Composition
    {
        /// <summary>
        /// 当前执行的节点索引
        /// </summary>
        ...
        public Selector(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
            OnCreate();
        }
