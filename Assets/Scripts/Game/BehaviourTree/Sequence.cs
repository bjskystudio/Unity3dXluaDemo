namespace LuaBehaviourTree
{
    ...
    public class Sequence : Composition
    {
        ...
        public Sequence(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
            OnCreate();
        }
