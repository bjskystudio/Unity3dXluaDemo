...
namespace LuaBehaviourTree
{
    ...
    public class CompareShareBool : BaseCondition
    {
        ...
        public CompareShareBool(BTNode node, TBehaviourTree btowner, BTNode parentnode, long worlditemuid, int instanceid) : base(node, btowner, parentnode, worlditemuid, instanceid)
        {
