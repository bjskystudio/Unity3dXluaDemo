...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class CNPRPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent opaqueTransparentTextureDownsamplingText = EditorGUIUtility.TrTextContent("Texture Downsampling", "The downsampling method that is used for the opaque transparent texture");
            ...
            public static GUIContent cameraBlurProcessText = EditorGUIUtility.TrTextContent("Camera Blur Process", "Camera blur process support.");
            public static GUIContent cameraBlurProcessDownsamplingText = EditorGUIUtility.TrTextContent("Downsampling", "This option controls the down sampling magnification when the camera is blurred. The higher the magnification, the better the efficiency.");
        ...
        void DrawQualitySettings()
        {
            ...
            if (m_QualitySettingsFoldout.value)
            {
                ...
                EditorGUILayout.Space();
                EditorGUILayout.LabelField(Styles.cameraBlurProcessText);
                EditorGUI.indentLevel++; 
