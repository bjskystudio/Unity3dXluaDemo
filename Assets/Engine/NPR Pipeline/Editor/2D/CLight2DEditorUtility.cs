...
{
    internal static class CLight2DEditorUtility
    {
        ...
        {
            //CNPRPipelineAsset pipelineAsset = CNPRPipeline.asset;
            //Renderer2DData rendererData = pipelineAsset != null ? pipelineAsset.scriptableRendererData as Renderer2DData : null;
            //if (rendererData == null)
            //{
            //    foreach (Camera camera in Camera.allCameras)
            //    {
            //        CAdditionalCameraData additionalCameraData = camera.GetComponent<CAdditionalCameraData>();
