...
namespace UnityEditor.Rendering.Universal
{
    ...
    [CustomEditorForRenderPipeline(typeof(Light), typeof(CNPRPipelineAsset))]
    class CNPRPipelineLightEditor : LightEditor
    {
...
#pragma warning restore 618
        ...
        {
            //NPR render-pipeline only supports baked area light, enforce it as this inspector is the NPR one.
        ...
        void DrawAdditionalShadowData()
        {
            ...
            if (hasChanged)
            {
                if (m_AdditionalLightDataSO == null)
                {
                    ...
                    CNPRPipelineAsset asset = GraphicsSettings.renderPipelineAsset as CNPRPipelineAsset;
        ...
        void ShadowsGUI()
        {
            ...
            // Bias is handled differently in NPR RP
        ...
        {
            if (!(GraphicsSettings.currentRenderPipeline is CNPRPipelineAsset))
                return;
