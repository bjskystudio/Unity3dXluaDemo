...
namespace UnityEditor.Rendering.Universal
{
        ...
        where T : IEquatable<T>
    {
        ...
        public CSavedParameter(string key, T value, GetParameter getter, SetParameter setter)
        {
