...
//<readonly> NGUI �ܽ� ,���ض���ģʽ����Ե�֣�֧��д��� (ע�⣺Shader�����UITexttureʹ��)
//@@@DynamicShaderInfoEnd
Shader "EngineCenter/UI/NGUI/NGUI - Dissolve - AlphaClip" {
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				float4 col = SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,i.uv)* i.color + clipValue*_lineColor*_lineColor.a;
				clip(col.a - 0.1);
