...
_G.serpent = {
    ...
    block = function(a, opts)
        local str = s(a, merge({indent = "  ", sortkeys = true, comment = false}, opts))
        print(debug.traceback())
        print(str)
        return str
    end,
    output = function(a, opts)
        local str = s(a, merge({indent = "  ", sortkeys = false, comment = false}, opts))
        -- print(str)
        return str
    end,
    getdumptext = function(a, opts)
        local str = s(a, merge({indent = "  ", sortkeys = false, comment = false}, opts))
        return str
    end,
}
