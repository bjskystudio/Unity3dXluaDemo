...
namespace UnityEditor.AI
{
    public class NavMeshAssetManager : ScriptableSingleton<NavMeshAssetManager>
    {
        ...
        static void CreateNavMeshAsset(NavMeshSurface surface)
        {
            ...
            if (currentBakeBackFunc != null)
            {
                currentBakeBackFunc(targetPath);
            }
        }
        ...
        public void StartBakingSurfaces(UnityEngine.Object[] surfaces, System.Action<string> func = null)
        {
            currentBakeBackFunc = func;
        ...
        private static System.Action<string> currentBakeBackFunc = null;
