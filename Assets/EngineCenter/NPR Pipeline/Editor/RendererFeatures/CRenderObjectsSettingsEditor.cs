...
{
	[CustomPropertyDrawer(typeof(CRenderObjectsFeature.CRenderObjectsSettings), true)]
    internal class CRenderObjectsSettingsEditor : PropertyDrawer
    {
	    internal class Styles
	    {
			...
			public static GUIContent eventOffset = new GUIContent("Event Offset", "Event Offset");
		...
		private SerializedProperty m_EventOffset;
        ...
        private void Init(SerializedProperty property)
        {
			...
			m_EventOffset = property.FindPropertyRelative("m_iRenderPassEventOffset");
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
	    {
			...
			//Event Offset
			EditorGUI.PropertyField(rect, m_EventOffset, Styles.eventOffset);
			rect.y += Styles.defaultLineSpace;
	    ...
	    {
		    float height = Styles.defaultLineSpace + 20;
