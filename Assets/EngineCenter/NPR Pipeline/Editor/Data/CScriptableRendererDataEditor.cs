...
{
    [CustomEditor(typeof(AScriptableRendererData), true)]
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class CScriptableRendererDataEditor : Editor
    {
        class Styles
        {
        ...
        {
            m_RenderPasses = serializedObject.FindProperty(nameof(AScriptableRendererData.m_RendererFeatures));
            m_RenderPassMap = serializedObject.FindProperty(nameof(AScriptableRendererData.m_RendererFeatureMap));
        ...
        private void DrawRendererFeature(int index, ref SerializedProperty prop)
        {
            ...
            else
            {
                ...
                {
                    var data = target as AScriptableRendererData;
        ...
        {
            var menu = new GenericMenu();
            var types = TypeCache.GetTypesDerivedFrom<AScriptableRendererFeature>();
            foreach (Type type in types)
            {
                string path = type.Name;// GetMenuNameFromType(type);
