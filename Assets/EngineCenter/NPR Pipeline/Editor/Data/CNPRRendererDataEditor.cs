...
{
    [CustomEditor(typeof(CNPRRendererData), true)]
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class CNPRRendererDataEditor : CScriptableRendererDataEditor
    {
        private static class Styles
        {
            //public static readonly GUIContent RendererTitle = new GUIContent("Forward Renderer", "Custom Forward Renderer for NPR Pipeline.");
            ...
            */
            ...
            if (EditorPrefs.GetBool("DeveloperMode"))
            {
                ...
                if (GUILayout.Button("Reload All"))
                {
                    ...
                    ResourceReloader.ReloadAllNullIn(target, CNPRPipelineAsset.packagePath);
                }
            }
        }
    }
