...
namespace UnityEditor.EngineCenter.NPRPipeline
{
    ...
    sealed class CTrackballUIDrawer
    {
        ...
        public void OnGUI(SerializedProperty property, ref bool b, /*SerializedProperty overrideState, */GUIContent title, Func<Vector4, Vector3> computeFunc)
        {
            ...
            {
                using (new EditorGUI.DisabledScope(!b/*overrideState.boolValue*/))
                    DrawWheel(ref value, b/*overrideState.boolValue*/);

                DrawLabelAndOverride(title, ref b/*overrideState*/);
            }
        ...
        void DrawLabelAndOverride(GUIContent title, ref bool b/*SerializedProperty overrideState*/)
        {
            // Title
            ...
            b = GUI.Toggle(overrideRect, b, EditorGUIUtility.TrTextContent("", "Override this setting for this volume."), CoreEditorStyles.smallTickbox);
        }
