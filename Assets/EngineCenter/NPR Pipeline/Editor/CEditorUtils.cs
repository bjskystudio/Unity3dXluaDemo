...
namespace UnityEditor.Rendering.Universal
{
    static class CEditorUtils
    {
        ...
        public static void CreateLayerInfo(out string[] asLayerNames/*, out int[] aiLayerValues*/)
        {
            ...
            asLayerNames = listName.ToArray();
            //aiLayerValues = listValue.ToArray();
        }
    }
}
