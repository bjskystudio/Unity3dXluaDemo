...
{
    public sealed partial class CNPRPipeline : RenderPipeline
    {
        ...
        static CCapsuleAOManager s_CapsuleAOManager = null;
        static CNPRPipelineRuntimeData s_NPRPipelineRuntimeData = null;
        ...
        public static float minCameraBlurProcessScale
        {
            get => 0.0f;
        }

        public static float maxCameraBlurProcessScale
        {
            get => 2.0f;
        }
        ...
        public static int maxPerObjectLights
        {
            ...
            get => 4;//(SystemInfo.graphicsDeviceType == GraphicsDeviceType.OpenGLES2) ? 4 : 8;
        }
        ...
        // Internal max count for how many ScriptableRendererData can be added to a single NPR RP asset
        public static int maxScriptableRenderers
        {
            get => 8;
        }

        public static CCapsuleAOManager GetCapsuleAOManager()
        {
            if (s_CapsuleAOManager == null)
                s_CapsuleAOManager = new CCapsuleAOManager();
            return s_CapsuleAOManager;
        }

        public static CNPRPipelineRuntimeData GetRuntimeData()
        {
            if (s_NPRPipelineRuntimeData == null)
                s_NPRPipelineRuntimeData = new CNPRPipelineRuntimeData();
            return s_NPRPipelineRuntimeData;
        }

        public CNPRPipeline(CNPRPipelineAsset asset)
        {
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            CShaderData.instance.Dispose();

#if UNITY_EDITOR
            CSceneViewDrawMode.ResetDrawMode();
#endif
        ...
        {
            CAdditionalCameraData additionalCameraData = null;
            if (IsGameCamera(camera))
        ...
        static void RenderSingleCamera(ScriptableRenderContext context, SCameraData cameraData, bool requiresBlitToBackbuffer, bool anyPostProcessingEnabled)
        {
        ...
        {
            baseCamera.TryGetComponent<CAdditionalCameraData>(out var baseCameraAdditionalData);
            ...
            if (cameraStack != null && cameraStack.Count > 0)
            {
                ...
                if (!IsMultiPassStereoEnabled(baseCamera))
                {
                    ...
                    for (int i = 0; i < cameraStack.Count; ++i)
                    {
                        ...
                        {
                            currCamera.TryGetComponent<CAdditionalCameraData>(out var data);
            ...
            for (int i = 0; i < cameraStack.Count; ++i)
            {
                ...
                currCamera.TryGetComponent<CAdditionalCameraData>(out var currCameraData);
                // Camera is overlay and enabled
                if (currCameraData != null)
                {
                    // Copy base settings from base camera data and initialize initialize remaining specific settings for this camera type.
                    SCameraData overlayCameraData = baseCameraData;
                    overlayCameraData.baseCamera = baseCameraData.camera;
        ...
        static void UpdateVolumeFramework(Camera camera, CAdditionalCameraData additionalCameraData)
        {
            ...
            else if (camera.cameraType == CameraType.SceneView)
            {
                ...
                CAdditionalCameraData mainAdditionalCameraData = null;
        ...
        static bool CheckPostProcessForDepth(in SCameraData cameraData)
        {
            ...
            //if (stack.GetComponent<CDepthOfField>().IsActive())
            if (CPostProcessManager.instance.IsActiveByEffect(EFFECT_TYPE.DEPTH_OF_FIELD))
                return true;
        ...
        static void SetSupportedRenderingFeatures()
        {
            ...
            CSceneViewDrawMode.SetupDrawMode();
#endif
        }

        static void InitializeCameraData(Camera camera, CAdditionalCameraData additionalCameraData, out SCameraData cameraData)
        {
            cameraData = new SCameraData();
        ...
        static void InitializeStackedCameraData(Camera baseCamera, CAdditionalCameraData baseAdditionalCameraData, ref SCameraData cameraData)
        {
            var settings = asset;
        ...
        static void InitializeAdditionalCameraData(Camera camera, CAdditionalCameraData additionalCameraData, ref SCameraData cameraData)
        {
            var settings = asset;
            ...
            cameraData.maxShadowDistance = Mathf.Min(GetRuntimeData().shadow_distance, camera.farClipPlane);
            ...
            if (cameraData.isSceneViewCamera)
            {
                ...
                cameraData.clearDepthForDepthOnlyPass = true;
                cameraData.bBlurProcessEnabled = false;
                cameraData.bBloomProcessEnabled = false;
                cameraData.postProcessEnabled = CoreUtils.ArePostProcessesEnabled(camera);
                cameraData.renderPostProcessingCulling = -1;
                cameraData.requiresDepthTexture = settings.supportsCameraDepthTexture;
                cameraData.requiresOpaqueTransparentTexture = settings.supportsCameraOpaqueTransparentTexture;
            ...
            else if (additionalCameraData != null)
            {
                ...
                cameraData.clearDepthForDepthOnlyPass = additionalCameraData.clearDepthForDepthOnlyPass;
                cameraData.bBlurProcessEnabled = additionalCameraData.renderBlurProcessing;
                cameraData.bBloomProcessEnabled = additionalCameraData.renderBloomProcessing;
                cameraData.postProcessEnabled = additionalCameraData.renderPostProcessing;
                cameraData.renderPostProcessingCulling = additionalCameraData.renderPostProcessingCulling;
                cameraData.maxShadowDistance = (additionalCameraData.renderShadows) ? cameraData.maxShadowDistance : 0.0f;
                cameraData.requiresDepthTexture = additionalCameraData.requiresDepthTexture;
                cameraData.requiresOpaqueTransparentTexture = additionalCameraData.requiresColorTexture;
            ...
            else
            {
                ...
                cameraData.renderPostProcessingCulling = 0;
                cameraData.requiresDepthTexture = settings.supportsCameraDepthTexture;
                cameraData.requiresOpaqueTransparentTexture = settings.supportsCameraOpaqueTransparentTexture;
                cameraData.renderer = asset.scriptableRenderer;
            }
            ...
            if (cameraData.renderType == CameraRenderType.Overlay)
            {
                ...
                cameraData.requiresOpaqueTransparentTexture = false;
            }
...
#pragma warning restore 0618
        ...
        static void InitializeRenderingData(CNPRPipelineAsset settings, ref SCameraData cameraData, ref CullingResults cullResults,
            bool requiresBlitToBackbuffer, bool anyPostProcessingEnabled, out SRenderingData renderingData)
        {
            ...
            if (cameraData.maxShadowDistance > 0.0f)
            {
                ...
                if (settings.additionalLightsRenderingMode == LightRenderingMode.PerPixel)
                {
                    for (int i = 0; i < visibleLights.Length; ++i)
                    {
                        ...
                        // NPR RP doesn't support additional directional lights or point light shadows yet
            ...
            if (s_CapsuleAOManager != null && mainLightIndex != -1)
            {
                Light mainLight = visibleLights[mainLightIndex].light;
                s_CapsuleAOManager.m_tranLightDir = mainLight.transform;
            }
...
#pragma warning restore
        ...
        static void InitializeShadowData(CNPRPipelineAsset settings, NativeArray<VisibleLight> visibleLights, bool mainLightCastShadows, bool additionalLightsCastShadows, out ShadowData shadowData)
        {
            ...
            //switch (settings.shadowCascade)
            switch (GetRuntimeData().shadow_cascades)
            {
            ...
            switch (shadowData.mainLightShadowCascadesCount)
            {
                ...
                case 2:
                    ...
                    shadowData.mainLightShadowCascadesSplit = new Vector3(GetRuntimeData().cascade_2_split, 1.0f, 0.0f);
                    break;
        ...
        static void InitializePostProcessingData(CNPRPipelineAsset settings, out PostProcessingData postProcessingData)
        {
        ...
        static void InitializeLightData(CNPRPipelineAsset settings, NativeArray<VisibleLight> visibleLights, int mainLightIndex, out LightData lightData)
        {
            int maxPerObjectAdditionalLights = CNPRPipeline.maxPerObjectLights;
            int maxVisibleAdditionalLights = CNPRPipeline.maxVisibleAdditionalLights;
        ...
        static int GetMainLightIndex(CNPRPipelineAsset settings, NativeArray<VisibleLight> visibleLights)
        {
        ...
        static void SetupPerCameraShaderConstants(in SCameraData cameraData)
        {
            Camera camera = cameraData.camera;
