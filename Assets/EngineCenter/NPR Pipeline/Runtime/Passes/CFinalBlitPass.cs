namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// consideration.
    /// </summary>
    public class CFinalBlitPass : AScriptableRenderPass
    {
        ...
        public CFinalBlitPass(RenderPassEvent evt, Material blitMaterial)
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref SRenderingData renderingData)
        {
            ...
            // Use default blit for XR as we are not sure the NPR RP blit handles stereo.
