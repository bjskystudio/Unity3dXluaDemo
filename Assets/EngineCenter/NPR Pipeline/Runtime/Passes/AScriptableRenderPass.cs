...
namespace UnityEngine.Rendering.Universal
{
    ...
    /// <summary>
    /// <c>ScriptableRenderPass</c> implements a logical rendering pass that can be used to extend NPR RP renderer.
    /// </summary>
    [MovedFrom("UnityEngine.Rendering.LWRP")] public abstract class AScriptableRenderPass
    {
        ...
        public void ConfigureTarget(RenderTargetIdentifier[] colorAttachments, RenderTargetIdentifier depthAttachment)
        {
            ...
            uint nonNullColorBuffers = CUtils.GetValidColorBufferCount(colorAttachments);
        ...
        public abstract void Execute(ScriptableRenderContext context, ref SRenderingData renderingData);
        ...
        {
            AScriptableRenderer.SetRenderTarget(cmd, destination, BuiltinRenderTextureType.CameraTarget, clearFlag, clearColor);
        ...
        [Obsolete("RenderPostProcessing only works with Post-processing v2. The use of the Post-processing Stack V2 is deprecated in the NPR Render Pipeline.")]
        ...
        public DrawingSettings CreateDrawingSettings(ShaderTagId shaderTagId, ref SRenderingData renderingData, SortingCriteria sortingCriteria)
        {
        ...
        public DrawingSettings CreateDrawingSettings(List<ShaderTagId> shaderTagIdList,
            ref SRenderingData renderingData, SortingCriteria sortingCriteria)
        {
        ...
        public static bool operator <(AScriptableRenderPass lhs, AScriptableRenderPass rhs)
        {
