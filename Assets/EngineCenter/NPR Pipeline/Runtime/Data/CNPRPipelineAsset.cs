...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class CNPRPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] ShadowCascades m_ShadowCascades = ShadowCascades.NoCascades;
...
#pragma warning restore 414
        ...
        [SerializeField] string[] m_asDisabledEffects;
        ...
        [SerializeField] bool m_bCameraBloomEnable = false;
        [SerializeField] [Range(0.0f, 50.0f)] float m_fCameraBloomIntensity = 0.0f;
        [SerializeField] [Range(0.0f, 10.0f)] float m_fCameraBloomThreshold = 1.0f;
        [SerializeField] [Range(0.0f, 10.0f)] float m_fCameraBloomStepBlurSpread = 6.0f;
        [SerializeField] Color m_colCameraBloomColor = Color.white;
        [SerializeField] Vector4 m_vCameraBloomBlendFactor = Vector4.one;

        // Capsule AO settings
        [SerializeField] bool m_bCapsuleAOEnable = false;
        [SerializeField] float m_fCapsuleAOFieldAngle = 0.5f;
        [SerializeField] float m_fCapsuleAOStrength = 1.0f;
        [SerializeField] int m_iMaxCapsuleAO = 32;
        ...
        */
        ...
        public ShadowCascades shadowCascade
        {
        ...
        {
            get { return m_SupportsHDR ? ColorGradingMode.HighDynamicRange : ColorGradingMode.LowDynamicRange; }// m_ColorGradingMode; }
        ...
        {
            get { return m_asDisabledEffects; }
            set { m_asDisabledEffects = value; }
        }

        public bool CheckDisabledEffect(string s)
        {
            if (m_asDisabledEffects != null)
            {
                for (int i = 0; i < m_asDisabledEffects.Length; ++i)
                {
                    if (string.Equals(s, m_asDisabledEffects[i]))
                        return true;
                }
            }
        ...
        {
            get { return m_bCameraBloomEnable; }
        }
        public float cameraBloomIntensity
        {
            get { return m_fCameraBloomIntensity; }
        }
        public float cameraBloomThreshold
        {
            get { return m_fCameraBloomThreshold; }
        }
        public float cameraBloomStepBlurSpread
        {
            get { return m_fCameraBloomStepBlurSpread; }
        }
        public Color cameraBloomColor
        {
            get { return m_colCameraBloomColor; }
        }
        public Vector4 cameraBloomBlendFactor
        {
            get { return m_vCameraBloomBlendFactor; }
        }
        public bool capsuleAOEnable
        {
            get { return m_bCapsuleAOEnable; }
        }
        public int maxCapsuleAO
        {
            get { return m_iMaxCapsuleAO; }
        }
        public float capsuleAOFieldAngle
        {
            get { return m_fCapsuleAOFieldAngle; }
        }
        public float capsuleAOStrength
        {
            get { return m_fCapsuleAOStrength; }
        }
