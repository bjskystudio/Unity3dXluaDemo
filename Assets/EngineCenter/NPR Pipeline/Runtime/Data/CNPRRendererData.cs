...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class CNPRRendererData : AScriptableRendererData
    {
#if UNITY_EDITOR
        ...
        internal class CreateForwardRendererAsset : EndNameEditAction
        {
            ...
            {
                var instance = CreateInstance<CNPRRendererData>();
                AssetDatabase.CreateAsset(instance, pathName);
                ResourceReloader.ReloadAllNullIn(instance, CNPRPipelineAsset.packagePath);
                Selection.activeObject = instance;
            }
        }

        [MenuItem("Assets/Create/Rendering/NPR Pipeline/Renderer Data", priority = CoreUtils.assetCreateMenuPriority2)]
        static void CreateForwardRendererData()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateForwardRendererAsset>(), "CustomNPRRendererData.asset", null, null);
        }
#endif
        ...
        protected override AScriptableRenderer Create()
        {
            ...
            {
                ResourceReloader.TryReloadAllNullIn(this, CNPRPipelineAsset.packagePath);
                ResourceReloader.TryReloadAllNullIn(postProcessData, CNPRPipelineAsset.packagePath);
            }
#endif
            return new CNPRRenderer(this);
        }
        ...
        protected override void OnEnable()
        {
            ...
            // We need to call the OnEnable for data migration when updating from old versions of NPR RP that
