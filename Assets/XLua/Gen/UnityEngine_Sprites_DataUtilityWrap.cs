...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSpritesDataUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.Sprites.DataUtility);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.Sprites.DataUtility();
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Sprite _sprite = (UnityEngine.Sprite)translator.GetObject(L, 1, typeof(UnityEngine.Sprite));
                        ...
                        var gen_ret = UnityEngine.Sprites.DataUtility.GetInnerUV( _sprite );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Sprite _sprite = (UnityEngine.Sprite)translator.GetObject(L, 1, typeof(UnityEngine.Sprite));
                        ...
                        var gen_ret = UnityEngine.Sprites.DataUtility.GetOuterUV( _sprite );
                        translator.PushUnityEngineVector4(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Sprite _sprite = (UnityEngine.Sprite)translator.GetObject(L, 1, typeof(UnityEngine.Sprite));
                        ...
                        var gen_ret = UnityEngine.Sprites.DataUtility.GetPadding( _sprite );
                        translator.PushUnityEngineVector4(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Sprite _sprite = (UnityEngine.Sprite)translator.GetObject(L, 1, typeof(UnityEngine.Sprite));
                        ...
                        var gen_ret = UnityEngine.Sprites.DataUtility.GetMinSize( _sprite );
