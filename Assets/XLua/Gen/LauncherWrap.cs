...
namespace XLua.CSObjectWrap
{
    ...
    public class LauncherWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "IsShowGuide", _g_get_IsShowGuide);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ShowSplash", _g_get_ShowSplash);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ShowStartCG", _g_get_ShowStartCG);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "IsOpenLocalUpdate", _g_get_IsOpenLocalUpdate);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "IsShowGuide", _s_set_IsShowGuide);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ShowSplash", _s_set_ShowSplash);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ShowStartCG", _s_set_ShowStartCG);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "IsOpenLocalUpdate", _s_set_IsOpenLocalUpdate);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_IsShowGuide(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Launcher gen_to_be_invoked = (Launcher)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.IsShowGuide);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ShowStartCG(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Launcher gen_to_be_invoked = (Launcher)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.ShowStartCG);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_IsOpenLocalUpdate(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Launcher gen_to_be_invoked = (Launcher)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.IsOpenLocalUpdate);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_IsShowGuide(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Launcher gen_to_be_invoked = (Launcher)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.IsShowGuide = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ShowStartCG(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Launcher gen_to_be_invoked = (Launcher)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ShowStartCG = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_IsOpenLocalUpdate(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Launcher gen_to_be_invoked = (Launcher)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.IsOpenLocalUpdate = LuaAPI.lua_toboolean(L, 2);
