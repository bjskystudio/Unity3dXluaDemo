...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 17, 7, 6);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetCurrentState", _m_GetCurrentState);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetCurrentState(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetCurrentState(  );
                        translator.Push(L, gen_ret);
